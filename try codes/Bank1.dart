...
class BankSimulation {
  ...
  Future<void> start() async {
    ...
    _calculateAndPrintMetrics();
  }

  void _calculateAndPrintMetrics() {
    ...
    print('Average Turnaround Time: ${totalTurnaroundTime / servedCustomers}');
    print('Average Waiting Time: ${totalWaitingTime / servedCustomers}');
    print('Average Response Time: ${totalResponseTime / servedCustomers}');
  }
}
